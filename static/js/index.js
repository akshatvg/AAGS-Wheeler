...
function postChatMessage (response) {
  ...
  var template_one = `
  <ul class="chat">
  <li class="left clearfix"><span class="chat-img pull-left" style="display: inline-block">
...
function displayResponse (response) {
  var wheele={response : response};
    var template_two =`
    <ul class="chat">
    <li align="right" class="right clearfix"><span class="chat-img pull-right">


                            <div class="chat-body clearfix" align="right"
                                style="padding:0;margin-bottom:0px;margin-right:0;">
                                <div class="header">
                                    <strong class="pull-right primary-font">Wheeler</strong>
                                    </div>
                                    <img src="../static/img/icons/favicon.png"
                                        style="height: 50px; display: inline-block; padding:0;margin-left:8px;"
                                        alt="wheeler Avatar" class="img-circle" />
                                <li>
                                    {{response}}
                                </li>
                            </div>
